...
export function SpendingPage() {
    ...
    const spendings = transactions.filter((transaction) => transaction.type === "spending");
        ...
        <>
            ...
            <main className="justify-center text-center text-white p-5 ">
                ...
                <div className="flex justify-center gap-2 mt-5">
                    <section className="w-5/10 space-y-2">
                        <div className="py-4 bg-[#1e1e1e] rounded-lg">
                            {spendings.length < 1 ? <p className="text-white/50">Nenhuma despesa esse mes.</p> : <p className="text-white/50">Suas ultimas despesas - {spendings.length}</p>}
                        </div>
