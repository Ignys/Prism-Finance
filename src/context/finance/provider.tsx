...
export function FinanceProvider({ children }: { children: ReactNode }) {
    ...
    const actionsValue = useMemo<FinanceActionsValue>(
        () => ({
            ...
            updateTransactionsBulk: store.updateTransactionsBulk,
            materializeTransaction: store.materializeTransaction,
            markTransactionAsPaid: store.markTransactionAsPaid,
            setTransactionStatus: store.setTransactionStatus,
